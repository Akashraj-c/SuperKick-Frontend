...
import { addCartApi, getAllWomensProductApi } from '../../services/allApi';
    ...
    return (
        <>
            ...
            <div style={{ marginTop: '140px', userSelect: 'none' }} >
                <p className='px-5 d-lg-flex d-none' style={{ color: 'rgba(94, 89, 89, 0.53)', fontSize: '14px' }}><Link to={'/'} className='text-decoration-none' style={{ color: 'rgba(94, 89, 89, 0.53)' }}>HOME</Link> / WOMENS </p>
            </div>
                    ...
                    <div className='col-md-9 mainCol'>
                        <div className="container- ">
                            <div className="row">
                                ...
                                {allWomensProduct.map((Item, index) => (
